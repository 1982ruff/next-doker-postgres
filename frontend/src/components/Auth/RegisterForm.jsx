        ...
        <Form {...form}>
          ...
          >
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input className="border-0 bg-Lynx_White" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div className="flex items-center py-4 space-x-4">
              <Checkbox onClick={() => setChecked(!checked)} id="terms" />
              <label
                htmlFor="terms"
                className="text-sm font-light leading-6 xl:text-base peer-disabled:cursor-not-allowed peer-disabled:opacity-80"
              >
