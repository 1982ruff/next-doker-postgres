...
const ProductCard = ({ title, image, price, id }) => {
  ...
  return (
    ...
    >
      ...
      {show && (
        <>
          <button className="absolute items-center justify-center bg-white rounded-full top-4 group right-4">
            <svg
              width="40"
              height="40"
              viewBox="0 0 40 40"
          ...
          <button className="absolute flex items-center justify-center w-10 h-10 bg-white rounded-full group top-16 right-4">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          >
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="transition-transform duration-200 ease-in-out group-hover:rotate-90"
            >
              <path
