...
const CartPage = () => {
  ...
  return (
    <section className="">
      ...
      <button
        className="p-4 px-5 py-3 mx-5 rounded-lg text-Lynx_White bg-Satoimo_Brown"
        onClick={clearCart}
      >
        Clear Cart
      </button>
      ...
      <div className="grid grid-cols-3 p-4">
        {/* Cart  */}
        {products.length > 0 ? (
          <div className="col-span-2 px-10 border rounded-2xl">
            {products.map((item, idx) => (
              <div className="flex items-center justify-between w-full">
                ...
                <button
                  ...
                  className="flex items-center justify-center rounded-lg size-10 hover:text-red-500 bg-Lynx_White"
                >
                  <svg
                    width="24"
                    height="24"
          ...
          <div className="flex flex-col items-center justify-center col-span-2 gap-6 p-10 border rounded-2xl">
        ...
        <div className="flex flex-col justify-start w-full col-auto gap-6 p-10 text-start rounded-2xl">
          <H4>Order Summary {totalItems ? `(${totalItems} items)` : null}</H4>
...
const CartDetail = ({ image, title, price, removeFromCart, id }) => {
  return (
